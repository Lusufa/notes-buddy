...
export const metadata: Metadata = {
  title: "Contact | Noterious",
  description:
    "Get in touch with Noterious, share your feedback, or ask any questions.",
};
...
export default function ContactPage() {
  return (
    <section className="relative z-10 my-20 mt-10 flex flex-col items-center justify-center gap-8">
      ...
      <a
        href="mailto:Noteriousmu@gmail.com"
      ...
      >
        rohitthakur2006rt2006@gmail.com
      </a>
    </section>
  );
}
